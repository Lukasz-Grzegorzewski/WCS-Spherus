...
CREATE TABLE
    IF NOT EXISTS `origins_digital_wcs`.`category` (
...
CREATE TABLE
    IF NOT EXISTS `origins_digital_wcs`.`color` (
        `id` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE
    IF NOT EXISTS `origins_digital_wcs`.`user` (
        `id` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE
    IF NOT EXISTS `origins_digital_wcs`.`video` (
        `id` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE
    IF NOT EXISTS `origins_digital_wcs`.`favorites` (
        `video_fav_id` INT NOT NULL,
        `user_id` INT NOT NULL,
        INDEX `user_id_idx` (`user_id` ASC) VISIBLE,
        INDEX `video_fav_id_idx` (`video_fav_id` ASC) VISIBLE,
        CONSTRAINT `user_id` FOREIGN KEY (`user_id`) REFERENCES `origins_digital_wcs`.`user` (`id`),
        CONSTRAINT `video_fav_id` FOREIGN KEY (`video_fav_id`) REFERENCES `origins_digital_wcs`.`video` (`id`)
    ) ENGINE = InnoDB DEFAULT CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci;
...
CREATE TABLE
    IF NOT EXISTS `origins_digital_wcs`.`hero_slider` (
        `id` INT NOT NULL AUTO_INCREMENT,
        `fk_video` INT NOT NULL,
        PRIMARY KEY (`id`),
        CONSTRAINT `fk_vid` FOREIGN KEY (`id`) REFERENCES `origins_digital_wcs`.`video` (`id`)
    ) ENGINE = InnoDB DEFAULT CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci;
...
CREATE TABLE
    IF NOT EXISTS `origins_digital_wcs`.`publicity` (
        `id` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE
    IF NOT EXISTS `origins_digital_wcs`.`video_category` (
        ...
        CONSTRAINT `fk_category_id` FOREIGN KEY (`category_id`) REFERENCES `origins_digital_wcs`.`category` (`id`),
        CONSTRAINT `fk_video_id` FOREIGN KEY (`video_id`) REFERENCES `origins_digital_wcs`.`video` (`id`)
    ) ENGINE = InnoDB DEFAULT CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci;
